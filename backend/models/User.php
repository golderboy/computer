...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return static::findOne(['id' => $id,'sta_id' => 0, 'status' => self::STATUS_ACTIVE]);
    }
    ...
    {
        return static::findOne(['username' => $username,'sta_id' => 0, 'status' => self::STATUS_ACTIVE]);
    }
